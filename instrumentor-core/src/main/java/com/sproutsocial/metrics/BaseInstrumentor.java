...
//    public static abstract class BaseBuilder<T extends BaseInstrumentor, B extends BaseBuilder> {
//        protected T instrumentor;
//        protected B builder;
//
//        protected abstract T getInstrumentor();
...
//        }
//
//        public B metricRegistry(MetricRegistry metricRegistry) {
//            this.metricRegistry = metricRegistry;
//            return builder;
//        }
//
//        public B healthCheckRegistry(HealthCheckRegistry healthCheckRegistry) {
//            this.healthCheckRegistry = healthCheckRegistry;
//            return builder;
//        }
//
//        public B exceptionFilter(Predicate<Throwable> filter) {
//            this.filter = filter;
//            return builder;
//        }
//
